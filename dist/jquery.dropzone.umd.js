...
(function (global, factory) {
	...
	(global = global || self, global.DropZone = factory(global.jQuery));
	...
	*/
	...
	DropZone = /*#__PURE__*/function () {
	  /**
	                                      * @param {Element} el
	                                      * @param {DropZone~Options} options
	                                      */
	  function DropZone(el, options) {var _this = this;_classCallCheck(this, DropZone);
	    /** @type {DropZone~Options} */
	    ...
	    var innerDragOver, innerDragEnter, innerDragLeave, innerDragDrop, startGlobalDrag, allowGlobalDrag, endGlobalDrag, globalDrop;

	    innerDragOver = function innerDragOver(event) {
	    ...
	    innerDragEnter = function innerDragEnter(event) {
	      if (typeof options.allowDrop === 'function' &&
	    ...
	    innerDragLeave = function innerDragLeave() {
	      if (typeof event !== 'undefined') {
	    ...
	    innerDragDrop = function innerDragDrop() {
	      endGlobalDrag();
	    };

	    startGlobalDrag = function startGlobalDrag(event) {
	      if (typeof options.allowDrop === 'function' &&
	      !options.allowDrop(event.originalEvent.dataTransfer)) {
	        event.preventDefault();
	        return;
	    ...
	    allowGlobalDrag = function allowGlobalDrag(event) {
	      if (typeof options.allowDrop === 'function' &&
	      !options.allowDrop(event.originalEvent.dataTransfer)) return;
	    ...
	    endGlobalDrag = function endGlobalDrag(event) {
	      if (typeof event !== 'undefined') {
	    ...
	    globalDrop = function globalDrop(_event) {
	      setTimeout(function () {
	        endGlobalDrag();
	      }, 0);
	    };
	  ...
	  }_createClass(DropZone, [{ key: "destroy", value: function destroy()
...
//# sourceMappingURL=jquery.dropzone.umd.js.map